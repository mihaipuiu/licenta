 ...
 */
final class Version20200527084137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE room_occupation CHANGE room_id room_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD created DATETIME NOT NULL, ADD updated DATETIME NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE facebook_id facebook_id VARCHAR(180) DEFAULT NULL, CHANGE picture_url picture_url VARCHAR(255) DEFAULT NULL');
    }
