 ...
 */
final class Version20200526224510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD facebook_id VARCHAR(180) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
